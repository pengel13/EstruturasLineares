...
class ComparadorVotosTest {
	...
	void setUp() {
		try {
			...
			Comparator<Candidato> comparaVotos = new CandidatoComparaVotos();
			listaOrdenada = new PriorityQueue<Candidato>(3, comparaVotos);
